...
CREATE TABLE Lives_At1(
    ...
    FOREIGN KEY(email) REFERENCES Users(email),
    FOREIGN KEY(street) REFERENCES Addresses(street)ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY(zip) REFERENCES Addresses(zip)ON DELETE CASCADE ON UPDATE CASCADE);
